...
* [KCast](https://github.com/Agundur-KDE/KCast) ⭐ 55 | 🐛 2 | 🌐 QML | 📅 2026-08-30 - A Plasma 6 widget to cast video files or YouTube URLs to a Chromecast device.
...
* [dictee](https://github.com/rcspam/dictee) ⭐ 57 | 🐛 3 | 🌐 Python | 📅 2026-08-30 - Push-to-talk voice dictation with KDE Plasma 6 plasmoid, PyQt6 setup wizard, and tray icon. 4 ASR backends (Parakeet, Vosk, Whisper, Canary), post-processing pipeline, translation. 100% local, 25+ languages.
...
* [Karousel](https://github.com/peterfajdiga/karousel) ⭐ 1,111 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-23 - KWin tiling script with scrolling. Works especially well with ultrawide screens.
...
* [Latte Dock NG](https://github.com/ruizhi-lab/latte-dock-ng) ⭐ 54 | 🐛 4 | 🌐 C++ | 📅 2026-08-30 is a Wayland-first dock for KDE Plasma 6.5+ that provides an elegant and intuitive experience for your tasks and widgets.
...
* [WhiteSur](https://github.com/vinceliuice/WhiteSur-kde) ⭐ 1,259 | 🐛 74 | 🌐 QML | 📅 2026-08-07 - A MacOS Big Sur theme for KDE Plasma.
...
* [Orchis](https://github.com/vinceliuice/Orchis-kde) ⭐ 330 | 🐛 23 | 🌐 QML | 📅 2025-10-18 - A materia Design theme for KDE Plasma desktop.
...
* [Fluent](https://github.com/vinceliuice/Fluent-kde) ⭐ 239 | 🐛 34 | 🌐 QML | 📅 2025-11-10 - A Microsoft inspired fluent Design theme for the KDE Plasma desktop.
...
* [KDE Configs](https://github.com/shalva97/kde-configuration-files) ⭐ 1,062 | 🐛 0 | 🌐 Shell | 📅 2025-02-27 - List of KDE configuration files and more.
