...
* [KCast](https://github.com/Agundur-KDE/KCast) ⭐ 57 | 🐛 1 | 🌐 QML | 📅 2026-09-14 - A Plasma 6 widget to cast video files or YouTube URLs to a Chromecast device.
...
* [Blitztext Linux](https://github.com/TimInTech/blitztext-linux) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Hotkey-driven voice dictation tray app for KDE Plasma/Wayland: hold a key, speak, and the local Whisper transcript is pasted into the active app. Optional LLM text workflows.

### Utilities & Tools

* [Yin-Yang](https://github.com/daehruoydeef/Yin-Yang) ⭐ 706 | 🐛 43 | 🌐 Python | 📅 2026-03-26 - Auto Night-mode for Linux.
* [fancontrol-gui](https://github.com/Maldela/fancontrol-gui) ⭐ 392 | 🐛 43 | 🌐 C++ | 📅 2025-05-13 - GUI for fancontrol which is part of lm\_sensors.
...
* [LocalTranslate](https://github.com/terslang/LocalTranslate) ⭐ 65 | 🐛 15 | 🌐 QML | 📅 2026-06-07 - Offline translation app built with Qt Quick that makes use of Firefox's [neural translation models](https://github.com/mozilla/firefox-translations-models) ⚠️ Archived.
* [dictee](https://github.com/rcspam/dictee) ⭐ 61 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - Push-to-talk voice dictation with KDE Plasma 6 plasmoid, PyQt6 setup wizard, and tray icon. 4 ASR backends (Parakeet, Vosk, Whisper, Canary), post-processing pipeline, translation. 100% local, 25+ languages.
...
* [Kvantum](https://github.com/tsujan/Kvantum) ⭐ 2,031 | 🐛 1 | 🌐 C++ | 📅 2026-08-25 - An SVG-based theme engine for Qt4/Qt5, KDE and LXQt, with an emphasis on elegance, usability and practicality.
* [Karousel](https://github.com/peterfajdiga/karousel) ⭐ 1,141 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-23 - KWin tiling script with scrolling. Works especially well with ultrawide screens.
...
* [Latte Dock NG](https://github.com/ruizhi-lab/latte-dock-ng) ⭐ 59 | 🐛 5 | 🌐 C++ | 📅 2026-09-18 is a Wayland-first dock for KDE Plasma 6.5+ that provides an elegant and intuitive experience for your tasks and widgets.
...
* [KPictureFrame](https://github.com/Agundur-KDE/KPictureFrame) ⭐ 5 | 🐛 0 | 🌐 QML | 📅 2026-09-14 - A Plasma 6 widget that turns your desktop into a picture frame.
...
* [WhiteSur](https://github.com/vinceliuice/WhiteSur-kde) ⭐ 1,271 | 🐛 76 | 🌐 QML | 📅 2026-08-07 - A MacOS Big Sur theme for KDE Plasma.
...
* [Layan](https://github.com/vinceliuice/Layan-kde) ⭐ 537 | 🐛 40 | 🌐 QML | 📅 2025-11-27 - A flat design theme for KDE Plasma desktop.
...
* [Fluent](https://github.com/vinceliuice/Fluent-kde) ⭐ 239 | 🐛 35 | 🌐 QML | 📅 2025-11-10 - A Microsoft inspired fluent Design theme for the KDE Plasma desktop.
...
* [SierraBreeze](https://github.com/ishovkun/SierraBreeze) ⭐ 355 | 🐛 35 | 🌐 C++ | 📅 2021-11-12 - OSX-like window decoration for KDE Plasma written in C++.
* [Sweet KDE](https://github.com/EliverLara/Sweet-kde) ⭐ 248 | 🐛 30 | 📅 2025-04-25 - A dark and modern theme for KDE plasma.
* [BreezeEnhanced](https://github.com/tsujan/BreezeEnhanced) ⭐ 214 | 🐛 0 | 🌐 C++ | 📅 2026-04-19 - A fork of KDE Breeze decoration with additional options.
...
* [breeze-gtk](https://github.com/KDE/breeze-gtk) ⭐ 87 | 🐛 0 | 🌐 SCSS | 📅 2026-09-14 - A GTK Theme Built to Match KDE's Breeze 📌.
...
* [Papirus](https://github.com/PapirusDevelopmentTeam/papirus-icon-theme) ⭐ 8,094 | 🐛 588 | 🌐 Shell | 📅 2026-08-01 - Material icon theme, initially based on Paper.
* [La Capitaine](https://github.com/keeferrourke/la-capitaine-icon-theme) ⭐ 1,996 | 🐛 115 | 🌐 Shell | 📅 2021-11-25 - Icon pack with inspiration taken from the latest iterations of macOS and Google's Material Design.
* [Tela](https://github.com/vinceliuice/Tela-icon-theme) ⭐ 1,877 | 🐛 104 | 🌐 Shell | 📅 2026-08-10 - A flat colorful Design icon theme.
...
* [Capitaine](https://github.com/keeferrourke/capitaine-cursors) ⭐ 1,238 | 🐛 16 | 🌐 Python | 📅 2022-06-05 - An x-cursor theme inspired by macOS and based on KDE Breeze.
...
* [Chili](https://github.com/MarianArlt/kde-plasma-chili) ⭐ 227 | 🐛 6 | 🌐 QML | 📅 2019-07-23 - The hottest login theme around for KDE **Plasma 5**.
